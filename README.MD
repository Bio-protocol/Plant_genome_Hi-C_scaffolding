...
cd ..
```
__Tips:__ Check juicer.sh, make sure all the queue name, queue_time, and threads fit your SLURM or SLF scheduler. If not, you may need to edit them in juicer.sh manually.
